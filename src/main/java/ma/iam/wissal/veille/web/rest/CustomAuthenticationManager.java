...
public class CustomAuthenticationManager implements AuthenticationManager {
    ...
    @Autowired
    private LdapTemplate grcLdapTemplate;
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        try {
            ...
            boolean isSuccess = autoAuth || grcLdapTemplate.authenticate("", "(sAMAccountName=" + login + ")", password);
            if(isSuccess) {
	...
	public UserDTO getInfosLdap(String login) throws Exception {
        ...
        try {
            results = grcLdapTemplate.search("",filter.encode(), new PersonAttributesMapper());
        } catch(Exception e) {
