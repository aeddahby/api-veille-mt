...
import ma.iam.wissal.veille.web.rest.errors.EmailAlreadyUsedException;
import ma.iam.wissal.veille.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
     ...
     */
    @PostMapping("/users")
    @PreAuthorize("hasAnyAuthority(\"" + AuthoritiesConstants.ADMIN + "," + AuthoritiesConstants.ANIMATEUR_CENTRAL + "\")")
