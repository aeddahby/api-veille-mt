...
import ma.iam.wissal.veille.repository.CategoryRepository;
import ma.iam.wissal.veille.service.CategoryService;
...
/**
 * REST controller for managing {@link ma.iam.wissal.veille.domain.Category}.
 */
@RestController
@RequestMapping("/api")
